...
class PetPersonAssociation(Base):
    ...
    __table_args__ = (
            UniqueConstraint('pet_id', 'person_id', 'nickname', name='person_pet_nickname_uniqueness_constraint'),
        )
    id = Column(Integer, primary_key=True)
...
if __name__ == "__main__":
    ...
    for nickname in nicknames:
        print "Pet Name: {}, Person Name: {}, Nickname: {}".format(nickname.pet.name, nickname.person.full_name, nickname.nickname)
    #################################################
